...
class NavSidebarRight extends Component {
  getOption = (n) => {
    ...
    var data3 = [];
    for (var i = 0; i < 40; i++) {
      let ran = Math.random()*Math.random()*Math.random();
        data1.push(ran);
        data2.push(-ran);
    }
    for (var i = 1; i < 9; i++) {
    ...
    return (
      <div className="main-navbar-right">
        <ul className="nav-right-content">
          ...
          <li>
            <p>top locations</p>
            <ReactEcharts option={this.getOption(1)} className="box-chart map" />
          ...
          <li>
            <p>monthly trend</p>
            <ReactEcharts option={this.getOption(3)} className="box-chart" />
            <div className="content-box right">
              <i className="fas fa-caret-right"></i>
            </div>
          </li>
            ...
            <ul>
              <li>
                <div className="cols">
                  ...
                  <div className="col extra-is-2 detail-profile-comment">
                    <p>Deve M wrote a comment:</p>
                  </div>
                  <div className="col is-1 box-comment-detail">
                    <p>Hey dude, how it going? We should catch up soon ...</p>
                  </div>
              ...
              <li>
                <div className="cols">
                  ...
                  <div className="col extra-is-2 detail-profile-comment">
                    <p>Adam D wrote a comment:</p>
                  </div>
                  <div className="col is-1 box-comment-detail">
                    <p>Loving the HDRI effect. Keep up the great work!</p>
                  </div>
                  <div className="col is-1 box-time-detail">
                    <p>4 days ago</p>
                  </div>
